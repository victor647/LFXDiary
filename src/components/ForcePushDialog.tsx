...
export function ForcePushDialog({ monthKey, entryCount, onCancel, onConfirm }: ForcePushDialogProps) {
  return (
    <div className="dialog-backdrop" role="presentation">
      <div className="force-push-dialog" role="dialog" aria-modal="true" aria-label="Force reserialize entries">
        ...
        <p>
          No unsynced entries were found in {monthKey}. Force reserialize and push {entryCount}
          {' '}
